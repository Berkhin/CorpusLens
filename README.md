...
[`docs/api.md`](./docs/api.md#getting-the-partition-out-scriptsexport_splitpy).
...
Contract details and the reasoning behind each decision: [`docs/api.md`](./docs/api.md).
Frontend structure and decisions: [`docs/frontend.md`](./docs/frontend.md).
...
**Measuring it corrected three things this README used to claim.** t-SNE was described as
...
**Manual**, per [`docs/api.md`](./docs/api.md) and [`docs/frontend.md`](./docs/frontend.md):
